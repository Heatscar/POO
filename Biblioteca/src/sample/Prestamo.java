...
public class Prestamo extends Libro{
    ...
    public Prestamo(String id, String titulo, String autor, String editorial, String edicion, String nombre, String direccion, String telefono, String fecha_inicial, String fecha_final, String fecha_entrega) 
    {
        super(id, titulo, autor, editorial, edicion);
